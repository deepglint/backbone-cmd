...
/***/ function(module, exports, __webpack_require__) {
	...
	window.bkb = __webpack_require__(7);
	var Vue = window.Vue = __webpack_require__(9);

	Vue.config.debug = true

	var VueValidator = __webpack_require__(11);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Confirm = __webpack_require__(8);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    ...
	    components: $.extend({
	        // 头部导航
	        'navbarview':               __webpack_require__(24)
	        // 左侧导航
	        ,'sidebarview':             __webpack_require__(29)
	        // 修改密码
	        ,'change_password_view':    __webpack_require__(34)
...
/***/ function(module, exports) {
	...
	module.exports = {
	    ...
	    methods: {
	        onClick: function(e) {
	            e.preventDefault();
	            this.main = 'change_password_view';
	        },
	        getVersion: function() {
	            var self = this;
	            $.get("version", function(d, s) {
	                self.version = window.version = (d.msg || "default").trim()
	            })
	        }
	    },
	    ready: function() {
...
/***/ function(module, exports) {
	...
	module.exports = "<nav class=\"navbar navbar-fixed-top\">\n        <div class=\"navbar-header\">\n            <img class=\"logo\" height=\"37\" v-bind=\"{src: path + '/logo_title.png'}\" />\n        </div>\n        <div class=\" navbar-collapse\" id=\"navbar-collapse-1\">\n            <ul class=\"nav navbar-nav navbar-right\">\n                <li class=\"version\">版本：{{version}}</li>\n                <!--<li class=\"dropdown\">\n                    <a href=\"#\" class=\"dropdown-toggle bkb-user\" data-toggle=\"dropdown\" role=\"button\" aria-expanded=\"true\">\n                        <span class=\"user\"></span> {{username}} <span class=\"dropdown-ico\"></span>\n                    </a>\n                    <ul class=\"dropdown-menu\" role=\"menu\">\n                        <li><a href=\"#\" v-on:click='onClick($event)'>修改密码</a></li>\n                        <li class=\"divider\"></li>\n                        <li><a href=\"logout\">退出</a></li>\n                    </ul>\n                </li>-->\n            </ul>\n        </div>\n</nav>";
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./changePwd.vue", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./changePwd.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".m-change-pwd .pwd-tip{\n    margin-top: 10px;\n    margin-bottom: 0;\n    font-size: 13px;\n}\n.m-change-pwd .form-group .tip {\n    margin-top: 7px;\n    display: inline-block;\n}", ""]);
...
/***/ function(module, exports) {
	...
	module.exports = {
	  ...
	  ready: function() {
	    ...
	    // modify by zhongjiewang
	    // time autochange bug fix
	    // options.parseInputDate = function(d) {
	    //     return moment(d, options.format)
	    // }
	    // create the control
